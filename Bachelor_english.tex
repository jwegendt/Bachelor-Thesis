...
\begin{example}[Failing the meta-variable occurs check]
    \begin{align*}
        \constraints &= \alphaunifvar \equiv \mathtt{5}\wedge \alphaunifvar \equiv \excopatmatch{\mathtt{hd\Rightarrow 5, tl\Rightarrow 7}}\xmapsto{\cref{unif5}}\bot
    \end{align*}
\end{example}
...
\subsection{Putting it together first}\label{sec:Putting it together}
