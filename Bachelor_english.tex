...
%TODO: reform this section i dont like it
...
%$\alphaunifvar \mapsto \lambda x.x$ and $\alphaunifvar \mapsto \lambda x.5$. %TODO: are these actually the only solutions?
...
There does not always exist a mgu, for instance in the problem provided above ($\alphaunifvar.\texttt{Ap}(5) \equiv 5$) %TODO: lieber dem bsp einen namen geben? oder noch eine hyperref?
...
When there is no substitution necessary, we may  write $\alphaunifvar, \betaunifvar$ instead of using the identity substitution. %TODO: das vorher einführen und dann definition verwenden?
...
In \cite{10.5555/2021953.2021960}, the authors describe a unification algorithm for an extension to the pattern unification discussed above.
