...
In higher-order unification, functions may appear: \dots
...
\end{prooftree}
\begin{prooftree}
    \AxiomC{$\Gamma,x: \tau_1\vdash t:\tau_2$}\RightLabel{\textsc{Cocase}}
...
\begin{align*}
    ...
    \vdash \betaunifvar\equiv \alphaunifvar.\expatmatch{\mathsf{Int}\Rightarrow\mathtt{True}}\\
    &\mapsto_s &\vdash&\mathsf{\alphaunifvar\equiv Int} &\wedge&
...
\end{align*}
%TODO: have i changed the numberin of the decomposing constraints?
...
\begin{definition}[Unification]
    \begin{align*}
        ...
        &\mapsto_s& \alphaunifvar \equiv e \tag{1}\\
        &\constraints \wedge \Psi \vdash \alphaunifvar \equiv e 
        &\mapsto_s& \constraints[e/\alphaunifvar] \wedge \Psi \vdash \alphaunifvar \equiv e \qquad (\alphaunifvar \notin e)\tag{2}
    \end{align*}
\end{definition}
Since substituting a solution for a unification variable in other constraints might yield a beta-redex or another simplifiable constraint, 
we need to continually apply decompositions and unifications to our equations.
