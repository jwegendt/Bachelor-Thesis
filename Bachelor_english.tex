...
\begin{example}[Taking apart codata using destructors]
    ...
    We will see how these examples resolve to $\mathtt{1}$ and $\mathtt{5}$ in \cref{sec:betaconv}.
\end{example} 
...
is a subset of higher-order unification, and its path to a solution is similarly simple as the one to first-order unification.
