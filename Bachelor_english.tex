...
$\Psi$ contains those variables we have seen before and want to remember. This motivates the the name context for $\Psi$, as well.
%TODO: too choppy
...
Also note that \cref{8} (as well as \cref{9} wich is just the mirror of \cref{8}) are possible through eta-conversion:
\begin{align*}
