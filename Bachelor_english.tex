...
$\Psi \vdash e\equiv t \Rightarrow FV(e)\subseteq \Psi \wedge FV(t)\subseteq \Psi$, %TODO: zeilenumbruch verhindern?
...
\begin{definition}[Decomposing constraints]
    ...
    \tag{3}\label{3}\\
    \circ\,&\Psi \vdash x.d({\overline{e}})\equiv x.d({\overline{t}})&\mapsto_d& \overline{\Psi\vdash e\equiv t}\tag{4}\label{4}\\
    *\,&\Psi \vdash x.\expatmatch{\overline{K(\overline{x})\Rightarrow e}}\equiv x.\expatmatch{\overline{K(\overline{x})\Rightarrow t}}&\mapsto_d& \overline{\Psi, \overline{x}\vdash e\equiv t}\tag{5}\label{5}\\
...
\begin{example}[Removing other contradictions]
    \begin{align*}
...
\begin{example}[Unification]
    ...
    \begin{align*}
        ...
        &\xmapsto{(\ref{3})}_d &\vdash\ & \mathtt{\alphaunifvar\equiv T}\qquad\wedge\vdash \mathtt{F\equiv F} &\wedge& 
        \vdash \betaunifvar\equiv \alphaunifvar.\expatmatch{\mathtt{T \Rightarrow 1, F\Rightarrow 5}}\\
        &\xmapsto{(\ref{3})}_d &\vdash\ & \mathtt{\alphaunifvar\equiv T} &\wedge& 
        \vdash \betaunifvar\equiv \alphaunifvar.\expatmatch{\mathtt{T \Rightarrow 1, F\Rightarrow 5}}\\
...
\begin{definition}[Unification]
    \begin{align*}
        ...
        &\mapsto_u& \constraints[e/\alphaunifvar] \wedge \Psi \vdash \alphaunifvar \equiv e &(\alphaunifvar \notin e)% \land\nexists\,\alphaunifvar\equiv t)
        \tag{2}\label{unif2}\\
        &\constraints \wedge \Psi \vdash \alphaunifvar \equiv e
        &\mapsto_u& \bot &(\alphaunifvar\in e) %\lor \exists \,\alphaunifvar\equiv t )
        \tag{3}\label{unif3}    
    \end{align*}
...
\begin{example}[Applying \cref{unif4} too early]
...
\end{example}%TODO: better spacing!
...
\begin{example}
    \begin{align*}
        ...
        &\wedge \vdash\alphaunifvar.\expatmatch{\mathtt{T\Rightarrow F, F\Rightarrow T}}\equiv \mathtt{T}.\expatmatch{\mathtt{T\Rightarrow \betaunifvar, F\Rightarrow T}}\\
        \xmapsto{(\ref{15})}_d& x\vdash \gamma^?\equiv \alphaunifvar.\expatmatch{\mathtt{T\Rightarrow 1, F\Rightarrow 2}}\wedge \vdash \alphaunifvar \equiv \mathtt{T}\wedge \vdash \mathtt{F}\equiv \betaunifvar\\%TODO: ref
