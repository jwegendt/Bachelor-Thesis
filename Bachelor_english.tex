...
is a subset of higher-order unification problems, and finding a solution is as simple as in to first-order unification.
...
In summary, I presented a higher-order unification algorithm solving pattern unification 
