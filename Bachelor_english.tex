...
\end{theorem} %TODO: was steht im buch dazu?
...
It was described fitst by Miller in ... %TODO: citation

%TODO: citation miller
\begin{definition}[Patterns unification / Pattern fragment]
    A pattern in a unification problem is any term $t$ where for its subterms of the form $\unifvar.\Ap{e_1.\Ap{... e_{n-1}.\Ap{e_n}}}$ 
    it holds that all $\listofexpr$ are distinct and bound variables in $t$ (NOT arbitrary expressions).
    %TODO: das mit dem listofexpr hier ist irreführend?
\end{definition}

The intuition here is that in the above case, $\unifvar$ is an unknown function, and anytime we apply an unknown function. ...
%TODO: ich kann die intuition nicht erklären...

\begin{theorem}[Decidability of Patterns Unification]
    Patterns Unification is decidable. If there exists a solution, there also exists an mgu.
\end{theorem}
