...
Finally, in \ref{The Algorithm For Higher-Order Unification}, I present the framework for our equations, and then go through our algorithm for higher-order unification problems in our calculus.
