...
and stops us from finding two different solutions for the same unification variable.
\end{definition}
...
\begin{example}[Failing the occurs check]
    ...
    \end{align*}%TODO: examples of failing the occurs check bc of same unif variable
\end{example}
