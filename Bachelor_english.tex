...
\begin{example}[No most general solution]\label{no most general}
    \begin{align*}
...
We formulate our constraints from a given unification problem as follows: %TODO: is the \text still necessary?
...
\begin{example}[Failing the occurs check]
    \begin{align*}
