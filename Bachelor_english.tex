...
We also use constructors for types. Simple Types like $\mathsf{Int, Bool, ...}$ are constructors on an empty sequence, 
...
\begin{example}[Using Copattern Matching to define Codata]
    \begin{align*}
