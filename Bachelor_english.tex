...
In this section, we want to explore how to simplify constraints.
...
\begin{align*}
    \excopatmatch{\overline{d(\overline{x})\Rightarrow e}}&\equiv 
    \excopatmatch{\overline{d(\overline{x})\Rightarrow t}}
    \mapsto \overline{d(\overline{x}) = d(\overline{x})} \land \overline{e \equiv t}\tag*{1,4}\\
    \excopatmatch{\overline{d(\overline{x})\Rightarrow e}}&\equiv t \mapsto \overline{e \equiv t.d(\overline{x})} \tag*{2,5}\\
    t&\equiv \excopatmatch{\overline{d(\overline{x})\Rightarrow e}} \mapsto \overline{t.d(\overline{x}) \equiv e} \tag*{3,6}
\end{align*}
