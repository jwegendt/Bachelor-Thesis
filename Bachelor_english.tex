...
\begin{example}
    ...
    \end{align*}     
    If we find the following solution $[x/ \alphaunifvar]$ through another equation, we would actually need to substitute in $\alphaunifvar$!
\end{example}
...
This is specific to higher-order unification, since in first-order unification we don't look at 
