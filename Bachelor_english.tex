...
\begin{align*}
    ...
    &\vdash \excopatmatch{\Ap{x}\Rightarrow \alphaunifvar} \equiv \excopatmatch{\Ap{x}\Rightarrow\betaunifvar} &&\mapsto&& \vdash \alphaunifvar \equiv \betaunifvar\\
    &\vdash x.\expatmatch{True \Rightarrow e} \equiv y.\expatmatch{True \Rightarrow t}&&\mapsto&& \vdash x\equiv y, e \equiv t
\end{align*}
